...
and YEAR(payment_date)<='$year2' and MONTH(payment_date)<='$month2'and is_check_out = 0";
...
?>
    ...
    <div style="text-align: center;">รายงานรายได้</div>
    <div style="text-align: center;font-size: 10px">
        ประจำเดือน <?php echo DateMonthThaiByDate("$year-$month-01"); ?> - <?php echo DateMonthThaiByDate("$year2-$month2-01"); ?>
    </div>
    <br>
