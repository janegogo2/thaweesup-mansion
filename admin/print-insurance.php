...
?>
    ...
    <table style="width: 100%;border-collapse: collapse;border-spacing: 0;margin-bottom: 20px;">
        ...
        <tr>
            ...
            <td class="service" style="text-align: left;padding: 20px;vertical-align: top;">ค่าประกันห้องพัก</td>
            <td class="unit"
        ...
        <tr>
            ...
            <td class="service" style="text-align: left;padding: 20px;vertical-align: top;">ค่าห้องล่วงหน้า เดือน <?php echo DateMonthThaiByDate($contract['contract_datetime']); ?></td>
            <td class="unit"
                style="text-align: right;padding: 20px;font-size: 1.2em;"><?php echo number_format($contract['room_price_before'], 2); ?></td>
            <td class="qty" style="text-align: right;padding: 20px;font-size: 1.2em;">1</td>
            <td class="total"
                style="text-align: right;padding: 20px;font-size: 1.2em;">
                <?php       
                                                           echo number_format($contract['room_price_before'], 2);
                                                        ?>
            </td>
        </tr>
        ...
        <tr>
            <td class="grand total" colspan="5"
                style="text-align: right;padding: 20px;font-size: 1.2em;border-top: 1px solid #5D6975;"><?php echo number_format($contract['insurance_price']+$contract['room_price_before'], 2); ?>
                <br><br>
                ( <?php echo toThaiBath($contract['insurance_price']); ?> )
            </td>
        </tr>
        </tbody>
    </table>
