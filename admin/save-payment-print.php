...
//$electric_bill = $conn->queryRaw("select * from service where service_id='1'", true);
//$water_bill = $conn->queryRaw("select * from service where service_id='2'", true);
...
?>
    ...
    <header class="clearfix" style="padding: 10px 0;margin-bottom: 30px;">
        ...
        <div style="float: right;width: 40%;line-height: 12pt">
            <h2 style="text-align: right">ใบแจ้งหนี้</h2>
    ...
    <table style="width: 100%;border-collapse: collapse;border-spacing: 0;margin-bottom: 20px;line-height: 12pt">
        ...
        <tr>
            <td colspan="3" style="text-align: center;border-top: 1px solid #5D6975;"> ( <?php echo toThaiBath($payment['electricity_price'] + $payment['water_price'] + $payment['room_price']); ?> )</td>
            <td style="text-align: right;padding: 20px;font-size: 1.2em;border-top: 1px solid #5D6975;">รวม</td>
            <td class="grand total"
                style="text-align: right;padding: 20px;font-size: 1.2em;border-top: 1px solid #5D6975;"><?php echo number_format($payment['electricity_price'] + $payment['water_price'] + $payment['room_price'], 2); ?>
            </td>
        ...
        <table width="100%">
            <tr>
                <td width="30%" align="left">
                    <div>หมายเหตุ 1. โอนเข้า SCB(ไทยพาณิชย์) 769-264615-9 นายศุภโชค รองาม</div>
                </td>
            ...
            <tr>
                <td width="70%" align="left">
                    <div>&nbsp;LINE : suphachokjane</div>
                </td>
                <td width="30%" align="center">
                    <div>&nbsp;ลงชื่อ ______________________ ผู้จัดทำ</div>
                </td>
            </tr>
            <tr>
                <td width="70%" align="left">
                    <div>&nbsp;2. กำหนดชำระวันที่ 5 ของทุกเดือน ล่าช้าปรับ วันละ 100 บาท</div>
                </td>
                <td width="30%" align="center">
